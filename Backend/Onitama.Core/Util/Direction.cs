...
public class Direction
{
    ...
    {
        return new Direction(XStep + other.XStep, YStep + other.YStep);
    }
    ...
    /// E.g. for the SouthWest direction, the start coordinate is at the right of the top row (playMatSize -1,playMatSize -1).
    /// </summary>
